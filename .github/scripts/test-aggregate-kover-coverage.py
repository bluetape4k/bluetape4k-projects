...
""",
    ...
    def test_ci_routes_search_messaging_changes_to_nats_and_elasticsearch(self):
        ...
        self.assertIn(":bluetape4k-elasticsearch:koverXmlReport -x test --max-workers=1", workflow)
        self.assertIn(":bluetape4k-nats:koverXmlReport -x test --max-workers=1", workflow)
