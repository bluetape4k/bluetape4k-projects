...
data class PhoneWithShallowCategory(@Id var id: Long): Serializable {
    ...
    @ShallowReference
    val shallowCategories: MutableSet<CategoryC> = mutableSetOf()

    @ShallowReference
    val shallowCategoryList: MutableList<CategoryC> = mutableListOf()

    @ShallowReference
    val shallowCategoryMap: MutableMap<String, CategoryC> = mutableMapOf()
