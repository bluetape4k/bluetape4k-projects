...
object Plugins {
    ...
    const val jooq = "nu.studer.jooq" // https://github.com/etiennestuder/gradle-jooq-plugin
...
object Versions {
    ...
    // NOTE: Jackson2 는 2.20.x 만 사용하세요
    ...
    const val hibernate = "6.6.41.Final"           // https://mvnrepository.com/artifact/org.hibernate.orm/hibernate-core
    ...
    const val micrometer = "1.16.2"         // https://mvnrepository.com/artifact/io.micrometer/micrometer-core
    const val micrometerTracing = "1.6.2"   // https://mvnrepository.com/artifact/io.micrometer/micrometer-tracing
    const val micrometerContextPropagation = "1.2.0" // https://mvnrepository.com/artifact/io.micrometer/context-propagation

    const val opentelemetry = "1.58.0" // https://mvnrepository.com/artifact/io.opentelemetry/opentelemetry-bom
    ...
    const val opentelemetryJavaAgent = "2.24.0" // https://mvnrepository.com/artifact/io.opentelemetry.javaagent/opentelemetry-javaagent
...
object Libs {
    ...
    val kotlinx_atomicfu = "org.jetbrains.kotlinx:atomicfu:${Versions.kotlinx_atomicfu}"
    ...
    const val commons_exec = "org.apache.commons:commons-exec:1.6.0"                // https://mvnrepository.com/artifact/org.apache.commons/commons-exec
    const val commons_io = "commons-io:commons-io:2.21.0"                           // https://mvnrepository.com/artifact/commons-io/commons-io
    const val commons_lang3 = "org.apache.commons:commons-lang3:3.20.0"             // https://mvnrepository.com/artifact/org.apache.commons/commons-lang3
    ...
    const val commons_pool2 = "org.apache.commons:commons-pool2:2.13.1"             // https://mvnrepository.com/artifact/org.apache.commons/commons-pool2
    ...
    const val commons_text = "org.apache.commons:commons-text:1.15.0"               // https://mvnrepository.com/artifact/org.apache.commons/commons-text
    const val commons_validator = "commons-validator:commons-validator:1.10.1"       // https://mvnrepository.com/artifact/commons-validator/commons-validator
    ...
    val aws2_kinesis = awsSdkV2("kinesis")
    ...
    val aws_kotlin_kinesis = awsKotlin("kinesis")
