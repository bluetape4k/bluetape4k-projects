...
const cards = [
    classCard({
        ...
        stereo: "<<Spring Data receiver>>",
        attrs: ["execute(statement): Mono<ResultSet>", "prepare(statement): Mono<PreparedStatement>"],
        fill: "#eff6ff",
        stroke: "#2563eb"
    }),
    classCard({
        ...
        w: 360,
        h: 174,
        name: "ReactiveCassandra\nOperations",
        stereo: "<<Spring Data receiver>>",
        attrs: ["select/count/exists CRUD API", "Flux and Mono result contracts"],
        fill: "#ecfdf5",
        stroke: "#16a34a"
    }),
    classCard({
        ...
        name: "AsyncCassandra\nOperations",
        stereo: "<<Spring Data receiver>>",
        attrs: ["CompletableFuture result API", "AsyncResultSet driver path"],
        fill: "#eff6ff",
        stroke: "#2563eb"
    }),
    classCard({
        ...
        attrs: ["receiver: ReactiveSession"],
        ops: ["executeSuspending(...)", "prepareSuspending(...)"],
        fill: "#eff6ff",
        stroke: "#2563eb"
    }),
    classCard({
        ...
        stereo: "<<extension file>>",
        attrs: ["receiver: ReactiveCassandraOperations"],
        ops: ["selectAsFlow(...)", "selectOne/count/exists suspending", "insert/update/delete/truncate"],
        fill: "#ecfdf5",
        stroke: "#16a34a"
    }),
    classCard({
        ...
        name: "AsyncCassandra\nOperations Coroutines",
        stereo: "<<extension file>>",
        attrs: ["receiver: AsyncCassandraOperations"],
        ops: ["executeSuspending(...)", "selectSuspending(...)", "sliceSuspending(...)"],
        fill: "#eff6ff",
        stroke: "#2563eb"
    }),
    classCard({
        ...
        w: 360,
        h: 186,
        name: "Batch and Select\nSupport",
        stereo: "<<extension files>>",
        attrs: ["ReactiveCassandraBatchOperations", "ReactiveSelectOperation"],
        ops: ["insert/update/delete Flow", "count/exists/first/one/all"],
        fill: "#f5f3ff",
        stroke: "#7c3aed"
    }),
    classCard({
        ...
        w: 360,
        h: 214,
        name: "CQL Options and\nCriteria DSL",
        stereo: "<<DSL helpers>>",
        attrs: ["QueryOptions, WriteOptions", "Criteria"],
        ops: ["query/write option builders", "addWriteOptions(...)", "Criteria.where(...) eq value"],
        fill: "#fff7ed",
        stroke: "#ea580c"
    }),
    classCard({
        ...
        stereo: "<<object>>",
        attrs: ["depends on CassandraOperations", "uses mappingContext + SchemaFactory"],
        ops: ["createTableAndTypes<T>()", "potentiallyCreateTableFor<T>()", "truncate<T>() if table exists"],
        fill: "#fdf2f8",
        stroke: "#db2777"
    }),
    classCard({
        ...
        w: 360,
        h: 158,
        name: "AbstractCassandra\nPersistable<PK>",
        stereo: "<<abstract class>>",
        attrs: ["Persistable<PK>", "Serializable"],
        ops: ["isNew(): id == null"],
        fill: "#f8fafc",
        stroke: "#64748b"
    }),
    classCard({
        ...
        name: "AbstractCassandra\nAuditable<U,PK>",
        stereo: "<<abstract class>>",
        attrs: ["Auditable<U,PK,Instant>"],
        ops: ["isNew(): createdAt == null"],
        fill: "#f8fafc",
        stroke: "#64748b"
    }),
];
