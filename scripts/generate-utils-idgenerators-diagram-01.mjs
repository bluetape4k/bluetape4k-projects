...
const bands = [
    band({
        ...
        w: 2820,
        h: 360,
        title: "Long output: sorted numeric identifiers",
        subtitle: "Use when storage wants compact numeric IDs and ordering."
    }),
    band({
        x: 90,
        y: 720,
        w: 2820,
        h: 360,
        title: "UUID output: standard 128-bit identifiers",
        subtitle: "Use when database and ecosystem tooling already expect UUID."
    }),
    band({
        x: 90,
        y: 1140,
        w: 2820,
        h: 360,
        title: "String output: lexicographic and URL-safe IDs",
        subtitle: "Use when IDs travel through URLs, logs, queues, or public APIs."
    }),
    band({
        x: 90,
        y: 1560,
        w: 2820,
        h: 300,
        title: "Encoding and obfuscation helpers",
        subtitle: "Use only when representation, not uniqueness generation, is the concern."
    }),
];
