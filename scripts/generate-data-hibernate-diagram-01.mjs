...
const cards = {
  caller:{x:85,y:170,w:360,h:170,fill:"#EFF6FF",stroke:c.blue,title:"Application Code",icon:"K",body:["works with standard JPA/Hibernate","adds Kotlin reified calls"]},
  em:{x:560,y:170,w:430,h:185,fill:"#EFF6FF",stroke:c.blue,title:"EntityManagerSupport",icon:"E",body:["save / delete / deleteById","findAs / exists / countAll","unwraps Session + connection"]},
  session:{x:1130,y:170,w:420,h:185,fill:"#F0FDFA",stroke:c.teal,title:"SessionSupport",icon:"S",body:["withBatchSize restores size","findByNaturalId helpers","typed HQL/native query"]},
  driver:{x:1700,y:170,w:420,h:185,fill:"#F8FAFC",stroke:c.gray,title:"Hibernate/JPA Runtime",icon:"H",body:["EntityManager / Session","SessionFactory / JDBC","Jakarta Persistence 3.2"]},
  criteria:{x:260,y:520,w:430,h:180,fill:"#F5F3FF",stroke:c.purple,title:"Criteria + TypedQuery",icon:"C",body:["createQueryAs / attribute","int/long result helpers","findOneOrNull + paging"]},
  stateless:{x:860,y:520,w:430,h:180,fill:"#FFF7ED",stroke:c.orange,title:"StatelessSession",icon:"B",body:["withStateless transaction scope","insert/update/delete batches","reified get/query helpers"]},
  querydsl:{x:1460,y:520,w:430,h:180,fill:"#F5F3FF",stroke:c.purple,title:"Querydsl Extensions",icon:"Q",body:["expression composition","projection helpers","JPA expression conversions"]},
  model:{x:260,y:860,w:430,h:185,fill:"#ECFDF5",stroke:c.green,title:"Entity Base Model",icon:"M",body:["JpaEntity + AbstractJpaEntity","Int/Long/UUID id bases","tree entity variants"]},
  converters:{x:860,y:860,w:430,h:185,fill:"#FEF2F2",stroke:c.red,title:"AttributeConverters",icon:"A",body:["locale/time/json helpers","compression + serialization","optional AES/Tink converters"]},
  listeners:{x:1460,y:860,w:430,h:185,fill:"#FFF7ED",stroke:c.orange,title:"Listeners + Spring Shim",icon:"L",body:["post-commit event listener","JPA lifecycle logger","TestEntityManager helper"]},
};
const flows = [
  [c.blue,"M445 255 L560 255","uses",503,230],[c.teal,"M990 255 L1130 255","unwraps",1060,230],[c.gray,"M1550 255 L1700 255","delegates",1625,230],
  [c.purple,"M775 355 L775 430 L475 430 L475 520","query API",625,405],[c.orange,"M1340 355 L1340 430 L1075 430 L1075 520","batch API",1210,405],[c.purple,"M1550 610 L1460 610","predicates",1505,585],
  [c.green,"M775 355 L775 800 L475 800 L475 860","entity contract",625,775],[c.red,"M1075 700 L1075 860","column mapping",1170,780],[c.orange,"M1675 700 L1675 860","events/tests",1770,780],
  [c.gray,"M1890 355 L1890 435 L1685 435 L1685 520","query factory",1790,410],
];
