...
const cards = {
    caller: {
        ...
        icon: "K",
        body: ["works with standard JPA/Hibernate", "adds Kotlin reified calls"]
    },
    em: {
        x: 560,
        y: 205,
        ...
        fill: "#EFF6FF",
        stroke: c.blue,
        title: "EntityManagerSupport",
        icon: "E",
        body: ["save / delete / deleteById", "findAs / exists / countAll", "unwraps Session + connection"]
    },
    session: {
        x: 1130,
        y: 205,
        ...
        icon: "S",
        body: ["withBatchSize restores size", "findByNaturalId helpers", "typed HQL/native query"]
    },
    driver: {
        x: 1700,
        y: 205,
        ...
        fill: "#F8FAFC",
        stroke: c.gray,
        title: "Hibernate/JPA Runtime",
        icon: "H",
        body: ["EntityManager / Session", "SessionFactory / JDBC", "Jakarta Persistence 3.2"]
    },
    criteria: {
        x: 260,
        y: 535,
        ...
        fill: "#F5F3FF",
        stroke: c.purple,
        title: "Criteria + TypedQuery",
        icon: "C",
        body: ["createQueryAs / attribute", "int/long result helpers", "findOneOrNull + paging"]
    },
    stateless: {
        x: 860,
        y: 535,
        ...
        icon: "B",
        body: ["withStateless transaction scope", "insert/update/delete batches", "reified get/query helpers"]
    },
    querydsl: {
        x: 1460,
        y: 535,
        ...
        fill: "#F5F3FF",
        stroke: c.purple,
        title: "Querydsl Extensions",
        icon: "Q",
        body: ["expression composition", "projection helpers", "JPA expression conversions"]
    },
    model: {
        x: 260,
        y: 875,
        ...
        fill: "#ECFDF5",
        stroke: c.green,
        title: "Entity Base Model",
        icon: "M",
        body: ["JpaEntity + AbstractJpaEntity", "Int/Long/UUID id bases", "tree entity variants"]
    },
    converters: {
        x: 860,
        y: 875,
        ...
        fill: "#FEF2F2",
        stroke: c.red,
        title: "AttributeConverters",
        icon: "A",
        body: ["locale/time/json helpers", "compression + serialization", "optional AES/Tink converters"]
    },
    listeners: {
        x: 1460,
        y: 875,
        ...
        fill: "#FFF7ED",
        stroke: c.orange,
        title: "Listeners + Spring Shim",
        icon: "L",
        body: ["post-commit event listener", "JPA lifecycle logger", "TestEntityManager helper"]
    },
};
const flows = [
    ...
    [c.purple, "M775 390 L775 453 Q775 465 763 465 L487 465 Q475 465 475 477 L475 535", "query API", 625, 440], [c.orange, "M1340 390 L1340 453 Q1340 465 1328 465 L1087 465 Q1075 465 1075 477 L1075 535", "batch API", 1210, 440],
    [c.green, "M815 390 L815 803 Q815 815 803 815 L487 815 Q475 815 475 827 L475 875", "entity contract", 645, 790], [c.red, "M1075 715 L1075 875", "column mapping", 1170, 800], [c.orange, "M1675 715 L1675 875", "events/tests", 1770, 800],
    [c.gray, "M1910 390 L1910 438 Q1910 450 1898 450 L1807 450 Q1795 450 1795 462 L1795 535", "query factory", 1852, 425],
];
...
function label(t, x, y) {
    const w = Math.max(78, t.length * 8.2 + 18);
    return `<g transform="translate(${x - w / 2} ${y - 16})"><rect width="${w}" height="28" rx="8" fill="#fff" stroke="${c.line}" opacity=".96"/><text class="label" x="${w / 2}" y="19" text-anchor="middle">${esc(t)}</text></g>`;
}
