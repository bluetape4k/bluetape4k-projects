...
const nodes = {
    ...
    reject: {
        ...
        fill: "#F8FAFC",
        stroke: colors.gray,
        title: "IN_PROGRESS rejects Cancel"
    },
};
...
const edges = [
    {
        ...
        to: "pending",
        d: "M119 427 L165 427",
        label: {x: 142, y: 402, text: "initial", w: 72}
    },
    {
        id: "request",
        color: colors.blue,
        ...
        to: "requested",
        d: "M395 418 L475 418",
        label: {x: 435, y: 392, text: "Request", w: 84}
    },
    {
        id: "confirm",
        color: colors.green,
        ...
        to: "confirmed",
        d: "M705 418 L785 418",
        label: {x: 745, y: 392, text: "Confirm", w: 84}
    },
    {
        id: "checkIn",
        color: colors.teal,
        from: "confirmed",
        to: "checkedIn",
        d: "M1015 418 L1095 418",
        label: {x: 1055, y: 392, text: "CheckIn", w: 86}
    },
    {
        id: "startTreatment",
        color: colors.orange,
        from: "checkedIn",
        to: "inProgress",
        d: "M1325 418 L1405 418",
        label: {x: 1365, y: 392, text: "Start", w: 62}
    },
    {
        id: "complete",
        color: colors.pink,
        from: "inProgress",
        to: "completed",
        d: "M1635 418 L1715 418",
        label: {x: 1675, y: 392, text: "Complete", w: 90}
    },
    ...
    {id: "cancelChecked", color: colors.purple, from: "checkedIn", to: "cancelWindow", d: "M1210 485 L1210 585"},
    {
        ...
        to: "cancelled",
        d: "M540 663 L540 775",
        label: {x: 640, y: 724, text: "Cancel -> final", w: 124}
    },
    {
        id: "markNoShow",
        color: colors.amber,
        ...
        to: "noShow",
        d: "M900 350 L900 285",
        label: {x: 780, y: 315, text: "MarkNoShow", w: 118}
    },
    {
        id: "rejectCancel",
        color: colors.gray,
        from: "inProgress",
        to: "reject",
        d: "M1520 485 L1520 775",
        label: {x: 1625, y: 680, text: "Cancel?", w: 78}
    },
];
