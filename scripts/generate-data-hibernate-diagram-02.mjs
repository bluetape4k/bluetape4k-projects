...
const boxes = {
  po:{x:115,y:200,w:410,h:160,fill:"#F8FAFC",stroke:c.gray,st:"<<interface>>",title:"PersistenceObject",attrs:["isPersisted: Boolean"],methods:["extends Serializable"]},
  apo:{x:115,y:500,w:410,h:170,fill:"#F8FAFC",stroke:c.gray,st:"<<abstract class>>",title:"AbstractPersistenceObject",attrs:["isPersisted = false"],methods:["extends AbstractValueObject"]},
  jpa:{x:630,y:200,w:410,h:160,fill:"#EFF6FF",stroke:c.blue,st:"<<interface>>",title:"JpaEntity<ID>",attrs:["id: ID?", "identifier: ID"],methods:["checkNotNull(id)"]},
  tree:{x:1440,y:200,w:520,h:170,fill:"#F0FDFA",stroke:c.teal,st:"<<interface>>",title:"JpaTreeEntity<T>",attrs:["parent: T?", "children: MutableSet<T>"],methods:["addChildren(...)", "removeChildren(...)"]},
  absJpa:{x:630,y:500,w:410,h:180,fill:"#EFF6FF",stroke:c.blue,st:"<<abstract class>>",title:"AbstractJpaEntity<ID>",attrs:["isPersisted = id != null"],methods:["equals uses id when persisted", "transient uses value signature"]},
  absTree:{x:1440,y:500,w:520,h:180,fill:"#F0FDFA",stroke:c.teal,st:"<<abstract class>>",title:"AbstractJpaTreeEntity<T,ID>",attrs:["parent @ManyToOne", "children @OneToMany"],methods:["no @MappedSuperclass", "QueryDSL limitation note"]},
  int:{x:220,y:830,w:340,h:170,fill:"#ECFDF5",stroke:c.green,st:"<<MappedSuperclass>>",title:"IntJpaEntity",attrs:["id: Int?", "@GeneratedValue IDENTITY"],methods:["simple integer id base"]},
  long:{x:600,y:830,w:340,h:170,fill:"#ECFDF5",stroke:c.green,st:"<<MappedSuperclass>>",title:"LongJpaEntity",attrs:["id: Long?", "@GeneratedValue IDENTITY"],methods:["simple long id base"]},
  uuid:{x:980,y:830,w:340,h:170,fill:"#ECFDF5",stroke:c.green,st:"<<MappedSuperclass>>",title:"UuidJpaEntity",attrs:["id: UUID?", "Uuid.V7.nextId()"],methods:["BINARY(16) column"]},
  intTree:{x:1370,y:830,w:420,h:170,fill:"#FFF7ED",stroke:c.orange,st:"<<MappedSuperclass>>",title:"IntJpaTreeEntity<T>",attrs:["id: Int?", "redeclares parent/children"],methods:["inherits tree helpers"]},
  longTree:{x:1800,y:830,w:420,h:170,fill:"#FFF7ED",stroke:c.orange,st:"<<MappedSuperclass>>",title:"LongJpaTreeEntity<T>",attrs:["id: Long?", "redeclares parent/children"],methods:["inherits tree helpers"]},
};
const edges=[
