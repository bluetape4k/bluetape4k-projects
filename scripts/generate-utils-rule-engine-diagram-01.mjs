...
const edges = [
    {
        ...
        to: "engine",
        tone: "rules",
        points: [[640, 360], [840, 360]],
        label: "sorted RuleSet",
        labelAt: [675, 333]
    },
    {
        id: "facts-to-engine",
        ...
        to: "engine",
        tone: "facts",
        points: [[640, 845], [740, 845], [740, 595], [840, 595]],
        label: "Facts input",
        labelAt: [660, 818]
    },
    {
        ...
        to: "rule",
        tone: "engine",
        points: [[1460, 455], [1690, 455]],
        label: "evaluate / execute",
        labelAt: [1505, 428]
    },
    {
        id: "engine-to-policy",
    ...
    },
    {
        ...
        to: "facts",
        tone: "facts",
        points: [[1690, 845], [1555, 845], [1555, 1110], [380, 1110], [380, 970]],
        label: "actions mutate facts",
        labelAt: [860, 1083]
    },
];
