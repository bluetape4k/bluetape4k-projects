...
const body = [
    ...
    edge({
        from: "R2dbcEntityOperations",
        to: "IdHelpers",
        points: [[760, 335], [410, 335], [410, 565]],
        color: "green",
        dashed: true,
        label: "extension receiver",
        labelAt: [450, 317]
    }),
    edge({
        from: "R2dbcEntityOperations",
        to: "SelectExtensions",
        points: [[1095, 455], [1095, 555]],
        color: "blue",
        dashed: true,
        label: "extension receiver",
        labelAt: [1115, 520]
    ...
    edge({
        from: "IdHelpers",
        to: "SelectExtensions",
        points: [[730, 720], [910, 720]],
        color: "green",
        label: "delegates after Query creation",
        labelAt: [755, 699]
    }),
    edge({
        from: "QueryObjects",
        to: "SelectExtensions",
        points: [[1720, 720], [1560, 720]],
        color: "slate",
        dashed: true,
        label: "query input",
        labelAt: [1600, 699]
    ...
    edge({
        ...
        to: "CoroutineSurface",
        points: [[1560, 640], [1700, 640], [1700, 455]],
        color: "teal",
        label: "await / Flow bridge",
        labelAt: [1588, 620]
    }),
];
