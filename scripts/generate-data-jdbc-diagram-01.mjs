...
const layers = [
  { x: 70, y: 165, w: 430, h: 620, title: "Caller contract", note: "SQL intent and receiver decide which helper path runs." },
  { x: 555, y: 165, w: 560, h: 620, title: "JDBC helper path", note: "Extensions keep resource scope, binding, batch, and transaction code short." },
  { x: 1170, y: 165, w: 440, h: 620, title: "Returned value", note: "Queries map rows; updates and batches return affected counts." },
];

const cards = {
  sql: { x: 125, y: 300, w: 320, h: 112, fill: "#EFF6FF", stroke: c.blue, title: "SQL + parameters", body: ["query/update text", { code: "params | batch rows" }] },
  receiver: { x: 125, y: 535, w: 320, h: 112, fill: "#F0FDF4", stroke: c.green, title: "DataSource / Connection", body: [{ code: "withConnect { conn }" }, "delegates to Connection APIs"] },
  tx: { x: 625, y: 280, w: 420, h: 112, fill: "#FAF5FF", stroke: c.purple, title: "Transaction scope", body: [{ code: "autoCommit = false" }, "commit or rollback + restore"] },
  prepared: { x: 625, y: 455, w: 420, h: 122, fill: "#F0FDFA", stroke: c.teal, title: "Prepared execution", body: [{ code: "prepareStatement(sql)" }, "bind params, execute query/update"] },
  batch: { x: 625, y: 640, w: 420, h: 112, fill: "#FFF7ED", stroke: c.orange, title: "Batch helpers", body: [{ code: "addBatch()" }, { code: "IntArray | LongArray" }] },
  result: { x: 1225, y: 300, w: 330, h: 112, fill: "#FDF2F8", stroke: c.pink, title: "ResultSet access", body: [{ code: "getXxxOrNull()" }, "label/index operators"] },
  mapper: { x: 1225, y: 480, w: 330, h: 112, fill: "#F7FEE7", stroke: c.lime, title: "Row mapping", body: [{ code: "mapFirst / mapSingle" }, { code: "toList / toMap / sequence" }] },
  counts: { x: 1225, y: 640, w: 330, h: 112, fill: "#F9FAFB", stroke: c.gray, title: "Update counts", body: ["affected rows", "generated keys optional"] },
};
