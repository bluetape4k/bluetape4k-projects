...
const body = [
    ...
    rootCard({
        ...
        kind: "publish",
        title: "bluetape4k/",
        subtitle: "foundation + BOM",
        items: roots["bluetape4k/"],
        badge: `${roots["bluetape4k/"].length}`
    }),
    rootCard({
        id: "io",
        x: 780,
        ...
        color: "teal",
        title: "io/",
        subtitle: "serialization, codecs, clients",
        items: roots["io/"],
        badge: `${roots["io/"].length}`
    }),
    rootCard({
        id: "data",
        x: 1595,
        ...
        color: "purple",
        title: "data/",
        subtitle: "database adapters",
        items: roots["data/"],
        badge: `${roots["data/"].length}`
    }),
    rootCard({
        id: "cache",
        x: 2180,
        ...
        color: "pink",
        title: "cache/",
        subtitle: "cache APIs/backends",
        items: roots["cache/"],
        badge: `${roots["cache/"].length}`
    }),
    rootCard({
        id: "infra",
        x: 125,
        ...
        color: "olive",
        title: "infra/",
        subtitle: "messaging, Redis, telemetry",
        items: roots["infra/"],
        badge: `${roots["infra/"].length}`
    }),
    rootCard({
        id: "spring",
        x: 940,
        ...
        kind: "app",
        title: "spring-boot/",
        subtitle: "Spring Boot 4 line",
        items: roots["spring-boot/"],
        badge: `${roots["spring-boot/"].length}`
    }),
    rootCard({
        id: "ktor",
        x: 1595,
        ...
        kind: "app",
        title: "ktor/",
        subtitle: "Ktor 3 server helpers",
        items: roots["ktor/"],
        badge: `${roots["ktor/"].length}`
    }),
    rootCard({
        id: "testing",
        x: 2170,
    ...
    rootCard({
        ...
        color: "amber",
        title: "utils/",
        subtitle: "domain utilities",
        items: roots["utils/"],
        badge: `${roots["utils/"].length}`
    }),
    rootCard({
        id: "vt",
        x: 1160,
        ...
        kind: "app",
        title: "virtualthread/",
        subtitle: "API + JDK adapters",
        items: roots["virtualthread/"],
        badge: `${roots["virtualthread/"].length}`
    }),
    rootCard({
        id: "siblings",
        x: 420,
        ...
        color: "gray",
        kind: "split",
        title: "standalone repos",
        subtitle: "published outside this Gradle build",
        items: [],
        badge: "external"
    }),
];
