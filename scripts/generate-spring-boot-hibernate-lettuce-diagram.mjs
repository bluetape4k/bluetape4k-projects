...
<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" role="img" aria-label="Spring Boot Hibernate Lettuce class structure">
  ...
  ${group({
        ...
        w: 396,
        h: 870,
        title: "AUTO-CONFIGURATION ENTRYPOINTS",
        note: "Conditions decide which beans are created.",
        fill: "#eff6ff",
        stroke: "#2563eb"
    })}
  ${group({
        ...
        w: 410,
        h: 870,
        title: "CREATED BEANS AND ADAPTERS",
        note: "Bean methods adapt Boot to cache contracts.",
        fill: "#f8fafc",
        stroke: "#64748b"
    })}
  ${group({
        ...
        note: "Hibernate and observers consume the adapters.",
        fill: "#ecfdf5",
        stroke: "#16a34a"
    })}
...
<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" role="img" aria-label="Spring Boot Hibernate Lettuce activation flow">
  ...
  ${group({
        ...
        h: 248,
        title: "INPUT",
        note: "Dependency and configuration start the path.",
        fill: "#eff6ff",
        stroke: "#2563eb"
    })}
  ${group({
        ...
        w: 446,
        h: 876,
        title: "HIBERNATE CACHE ACTIVATION",
        note: "Settings are prepared before Hibernate builds the RegionFactory.",
        fill: "#ecfdf5",
        stroke: "#16a34a"
    })}
  ${group({
        ...
        w: 420,
        h: 876,
        title: "BACK-OFF AND OBSERVABILITY",
        note: "Disabled, metrics, and Actuator paths stay separate.",
        fill: "#f8fafc",
        stroke: "#64748b"
    })}
