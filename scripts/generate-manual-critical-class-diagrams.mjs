...
function okioAsyncHierarchy() {
    ...
    const routes = [
        ...
        inherit("realSink", "bufferedSink", "green", [{x: 1130, y: 455}, {x: 1130, y: 365}, {x: 690, y: 365}, {
            x: 690,
            y: 317
        }]),
        inherit("fileSource", "source", "olive", [{x: 390, y: 735}, {x: 390, y: 655}, {x: 80, y: 655}, {
            x: 80,
            y: 145
        }, {x: 1060, y: 145}, {x: 1060, y: 185}]),
        inherit("socketSource", "source", "blue", [{x: 760, y: 735}, {x: 760, y: 635}, {x: 120, y: 635}, {
            x: 120,
            y: 160
        }, {x: 1060, y: 160}, {x: 1060, y: 185}]),
        inherit("realSource", "bufferedSource", "teal", [{x: 1130, y: 735}, {x: 1130, y: 655}, {
            x: 1740,
            y: 655
        }, {x: 1740, y: 145}, {x: 1430, y: 145}, {x: 1430, y: 185}]),
...
function testcontainersHierarchy() {
    ...
    const routes = [
        ...
        inherit("floci", "aws", "pink", [{x: 70, y: 731}, {x: 50, y: 731}, {x: 50, y: 335}, {x: 240, y: 335}, {
            x: 240,
            y: 317
        }]),
        inherit("localstack", "aws", "olive", [{x: 240, y: 875}, {x: 240, y: 820}, {x: 430, y: 820}, {
            x: 430,
            y: 335
        }, {x: 240, y: 335}, {x: 240, y: 317}]),

        inherit("mysql", "generic", "blue", [{x: 780, y: 455}, {x: 780, y: 370}, {x: 950, y: 370}, {x: 950, y: 317}]),
        inherit("kafka", "generic", "green", [{x: 1160, y: 455}, {x: 1160, y: 350}, {x: 950, y: 350}, {
            x: 950,
            y: 317
        }]),
        inherit("redis", "generic", "pink", [{x: 610, y: 741}, {x: 540, y: 741}, {x: 540, y: 337}, {
            x: 950,
            y: 337
        }, {x: 950, y: 317}]),
        inherit("mailpit", "generic", "amber", [{x: 1330, y: 741}, {x: 1370, y: 741}, {x: 1370, y: 337}, {
            x: 950,
            y: 337
        }, {x: 950, y: 317}]),
        inherit("http", "generic", "gray", [{x: 610, y: 961}, {x: 500, y: 961}, {x: 500, y: 325}, {
            x: 950,
            y: 325
        }, {x: 950, y: 317}]),
        inherit("webflux", "generic", "teal", [{x: 1330, y: 961}, {x: 1415, y: 961}, {x: 1415, y: 325}, {
            x: 950,
            y: 325
        }, {x: 950, y: 317}]),
        ...
        inherit("postgis", "postgres", "olive", [{x: 1770, y: 741}, {x: 1820, y: 741}, {x: 1820, y: 335}, {
            x: 1600,
            y: 335
        }, {x: 1600, y: 317}]),
    ];
