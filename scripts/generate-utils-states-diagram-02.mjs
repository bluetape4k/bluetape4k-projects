...
const cards = {
    ...
    suspendApi: {
        ...
        fill: "#ECFDF5",
        stroke: colors.green,
        title: "SuspendStateMachineInterface<S, E>",
        kind: "interface"
    },
    reactiveApi: {
        x: 1485,
        ...
        fill: "#F0FDFA",
        stroke: colors.teal,
        title: "ReactiveStateMachine<S, E, F>",
        kind: "interface"
    },
    syncImpl: {
        x: 115,
    ...
    reactiveImpl: {
        ...
        fill: "#F0FDFA",
        stroke: colors.teal,
        title: "DefaultReactiveStateMachine<S, E, F>",
        kind: "class"
    },
    registry: {
        x: 800,
...
const edges = [
    {
        ...
        from: "syncApi",
        to: "base",
        d: "M335 420 L335 360 L920 360 L920 317",
        label: {x: 628, y: 338, text: "extends", w: 82}
    },
    {
        id: "suspendBase",
        type: "extends",
        ...
        from: "suspendApi",
        to: "base",
        d: "M1020 420 L1020 317",
        label: {x: 1090, y: 372, text: "extends", w: 82}
    },
    {
        id: "reactiveBase",
        type: "extends",
        ...
        from: "reactiveApi",
        to: "base",
        d: "M1705 420 L1705 360 L1120 360 L1120 317",
        label: {x: 1412, y: 338, text: "extends", w: 82}
    },
    {
        id: "syncImplApi",
        type: "implements",
        ...
        to: "syncApi",
        d: "M335 675 L335 570",
        label: {x: 420, y: 624, text: "implements", w: 106}
    },
    {
        id: "suspendImplApi",
        type: "implements",
        ...
        from: "suspendImpl",
        to: "suspendApi",
        d: "M1020 675 L1020 570",
        label: {x: 1112, y: 624, text: "implements", w: 106}
    },
    {
        id: "reactiveImplApi",
        type: "implements",
        ...
        from: "reactiveImpl",
        to: "reactiveApi",
        d: "M1705 675 L1705 570",
        label: {x: 1800, y: 624, text: "implements", w: 106}
    },
    {
        id: "syncRegistry",
        type: "has",
        ...
        from: "syncImpl",
        to: "registry",
        d: "M335 825 L335 875 L910 875 L910 925",
        label: {x: 622, y: 852, text: "has registry", w: 112}
    },
    {
        id: "suspendRegistry",
        type: "has",
        ...
        from: "suspendImpl",
        to: "registry",
        d: "M1020 825 L1020 925",
        label: {x: 1114, y: 874, text: "has registry", w: 112}
    },
    {
        id: "reactiveRegistry",
        type: "has",
        ...
        from: "reactiveImpl",
        to: "registry",
        d: "M1705 825 L1705 875 L1130 875 L1130 925",
        label: {x: 1418, y: 852, text: "has registry", w: 112}
    },
    {
        id: "registryKey",
        type: "has",
        ...
        from: "registry",
        to: "key",
        d: "M895 1067 L895 1125 L270 1125 L270 1150",
        label: {x: 582, y: 1104, text: "exact", w: 64}
    },
    {
        id: "registryParent",
        type: "has",
        ...
        from: "registry",
        to: "parentKey",
        d: "M980 1067 L980 1137 L725 1137 L725 1150",
        label: {x: 852, y: 1124, text: "parent", w: 76}
    },
    {
        id: "registryTarget",
        type: "has",
        ...
        from: "registry",
        to: "target",
        d: "M1100 1067 L1100 1125 L1180 1125 L1180 1150",
        label: {x: 1140, y: 1104, text: "target", w: 72}
    },
];
