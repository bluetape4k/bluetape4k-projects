...
layer({ x: 56, y: 118, w: 232, h: 580, title: "Application", subtitle: "instrumented code", fill: C.grayFill, stroke: C.grayStroke });
layer({ x: 324, y: 118, w: 316, h: 580, title: "bluetape4k helpers", subtitle: "Kotlin DSL and lifecycle guards", fill: "#f8fafc", stroke: "#cbd5e1" });
layer({ x: 676, y: 118, w: 300, h: 580, title: "OpenTelemetry SDK", subtitle: "providers, processors, readers", fill: "#fff7ed", stroke: "#fed7aa" });
layer({ x: 1012, y: 118, w: 292, h: 580, title: "Export targets", subtitle: "logging, memory, external backends", fill: "#f0fdfa", stroke: "#99f6e4" });
