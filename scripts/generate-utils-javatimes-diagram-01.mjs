...
const edges = [
  { id: "foundationInterval", color: colors.blue, d: "M460 330 L590 330", from: "foundation", to: "interval", label: { x: 525, y: 303, text: "builds on", w: 90 } },
  { id: "foundationRanges", color: colors.blue, d: "M460 415 L480 415 L480 650 L590 650", from: "foundation", to: "calendarRanges", label: { x: 480, y: 540, text: "temporal types", w: 116 } },
  { id: "policyBusiness", color: colors.gray, d: "M460 715 L500 715 L500 500 L1575 500 L1575 410", from: "calendarPolicy", to: "business", label: { x: 558, y: 500, text: "rules", w: 62 } },
  { id: "topOutcome", color: colors.green, d: "M1750 320 L1885 320 L1885 900 L1690 900", from: "business", to: "outcomes", label: { x: 1844, y: 612, text: "answers", w: 82 } },
  { id: "bottomOutcome", color: colors.teal, d: "M1575 740 L1575 795 L1180 795 L1180 840", from: "coroutines", to: "outcomes", label: { x: 1518, y: 804, text: "streams", w: 82 } },
];
...
<rect class="module" x="535" y="185" width="1285" height="605" rx="8"/>
<text class="moduleTitle" x="560" y="212">bluetape4k-javatimes module capabilities</text>
