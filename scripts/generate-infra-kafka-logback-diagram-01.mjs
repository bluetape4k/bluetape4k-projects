...
const boxes = {
  logbackBase: {
    x: 80, y: 155, w: 360, h: 160, fill: "#F8FAFC", stroke: c.logback,
    stereo: "Logback APIs", title: "Appender Infrastructure", members: ["UnsynchronizedAppenderBase", "AppenderAttachable<E>", "Encoder<E>"],
  },
  abstractAppender: {
    x: 545, y: 135, w: 430, h: 200, fill: "#EFF6FF", stroke: c.appender,
    stereo: "abstract class", title: "AbstractKafkaAppender<E>", members: ["bootstrapServers, topic, acks", "keyProvider: KafkaKeyProvider", "exporter: KafkaExporter", "encoder: Encoder<E>"],
  },
  kafkaAppender: {
    x: 545, y: 425, w: 430, h: 210, fill: "#EFF6FF", stroke: c.appender,
    stereo: "class", title: "KafkaAppender<E>", members: ["defer Kafka client logs", "encode event -> ProducerRecord", "export(..., exceptionHandler)", "flush/close producer on stop"],
  },
  producer: {
    x: 545, y: 795, w: 430, h: 160, fill: "#F0FDF4", stroke: c.kafka,
    stereo: "Kafka client", title: "KafkaProducer", members: ["Producer<ByteArray, ByteArray>", "send(record, callback)", "flush() / close()"],
  },
  keyApi: {
    x: 80, y: 410, w: 360, h: 150, fill: "#FFF7ED", stroke: c.key,
    stereo: "interface", title: "KafkaKeyProvider<E>", members: ["+ get(event): ByteArray?", "null means unkeyed record"],
  },
  keyBase: {
    x: 80, y: 610, w: 360, h: 170, fill: "#FFF7ED", stroke: c.key,
    stereo: "abstract class", title: "AbstractKafkaKeyProvider", members: ["ContextAwareBase + LifeCycle", "resets errorWasShown", "base for context-aware keys"],
  },
  keyImpls: {
    x: 80, y: 830, w: 360, h: 170, fill: "#FFF7ED", stroke: c.key,
    stereo: "classes", title: "Key Provider Implementations", members: ["Hostname / Logger / Thread", "ContextName extend base", "Null implements interface"],
  },
  exporterApi: {
    x: 1090, y: 155, w: 360, h: 150, fill: "#FAF5FF", stroke: c.exporter,
    stereo: "interface", title: "KafkaExporter", members: ["+ export(producer, record, event)", "returns immediate success flag"],
  },
  defaultExporter: {
    x: 1090, y: 425, w: 360, h: 166, fill: "#FAF5FF", stroke: c.exporter,
    stereo: "class", title: "DefaultKafkaExporter", members: ["producer.send(record)", "callback delegates failures", "buffer/timeout -> false"],
  },
  handlerApi: {
    x: 1485, y: 395, w: 260, h: 142, fill: "#ECFDF5", stroke: c.handler,
    stereo: "fun interface", title: "ExportExceptionHandler", members: ["+ handle(event, error)", "custom fallback contract"],
  },
  appenderHandler: {
    x: 1485, y: 605, w: 260, h: 144, fill: "#ECFDF5", stroke: c.handler,
    stereo: "KafkaAppender owned", title: "Fallback Handler", members: ["warn on exception", "append to fallback appenders"],
  },
  fallback: {
...
const edges = [
  ...
  { cls: "assoc", d: "M 545 286 H 500 V 475 H 440", color: c.key, marker: "openOrange", label: ["keyProvider", 492, 450] },
  ...
  { cls: "uses", d: "M 1090 575 H 1015 V 855 H 975", color: c.kafka, marker: "openGreen", label: ["send()", 1036, 625] },
];
