...
const boxes = {
    ...
    asyncSession: {
        ...
        stroke: c.gray,
        stereo: "<<driver>>",
        title: "AsyncCqlSession",
        attrs: ["async driver session"],
        methods: ["executeAsync(...)", "prepareAsync(...)"]
    },
    statement: {
        x: 1205,
        y: 175,
        ...
        attrs: ["Simple, Bound, Batch"],
        methods: ["driver native CQL objects"]
    },
    row: {
        x: 1770,
        y: 175,
        ...
        methods: ["codec registry", "typed getters"]
    },
    sessionSupport: {
        x: 115,
        y: 535,
        ...
        fill: "#EFF6FF",
        stroke: c.blue,
        stereo: "<<extension file>>",
        title: "CqlSessionSupport",
        attrs: ["cqlSession { builder }", "cqlSessionOf(defaults...)"],
        methods: ["builds CqlSessionBuilder", "applies contact/keyspace"]
    },
    asyncSupport: {
        x: 665,
        y: 535,
        ...
        stroke: c.teal,
        stereo: "<<extension file>>",
        title: "AsyncCqlSessionSupport",
        attrs: ["executeSuspending(...)", "prepareSuspending(...)"],
        methods: ["wraps statementOf(...)", "awaits CompletionStage"]
    },
    statementSupport: {
        x: 1215,
        y: 535,
        ...
        stroke: c.orange,
        stereo: "<<extension file>>",
        title: "StatementSupport",
        attrs: ["statementOf / simpleStatementOf", "boundStatementOf / batchStatementOf"],
        methods: ["validates nonblank CQL", "returns new driver statements"]
    },
    rowSupport: {
        x: 1765,
        y: 535,
        ...
        stereo: "<<extension file>>",
        title: "RowSupport",
        attrs: ["toMap / toNamedMap", "mapWithName / codecs"],
        methods: ["decodes via TypeCodec", "sorts named output"]
    },
    provider: {
        x: 115,
        y: 930,
        ...
        stroke: c.blue,
        stereo: "<<object>>",
        title: "CqlSessionProvider",
        attrs: ["default contact/datacenter", "keyspace session cache"],
        methods: ["newCqlSessionBuilder(...)", "getOrCreateSession(...)"]
    },
    querybuilder: {
        x: 665,
        y: 930,
        ...
        fill: "#F5F3FF",
        stroke: c.purple,
        stereo: "<<extension package>>",
        title: "querybuilder/*",
        attrs: ["bindMarker / raw / udt", "relation and term helpers"],
        methods: ["delegates to QueryBuilder", "keeps generated CQL native"]
    },
    admin: {
        x: 1215,
        y: 930,
        ...
        stroke: "#DC2626",
        stereo: "<<object>>",
        title: "CassandraAdmin",
        attrs: ["create/drop keyspace", "release version lookup"],
        methods: ["uses SchemaBuilder", "queries system.local"]
    },
    dataSupport: {
        x: 1765,
        y: 930,
        ...
        stereo: "<<extension package>>",
        title: "data/*",
        attrs: ["GettableSupport", "SettableSupport"],
        methods: ["reified typed access", "name, id, or index overloads"]
    },
};
...
const edges = [
    ...
    {type: "uses", color: c.green, d: "M1935 535 L1935 343", label: {x: 2028, y: 450, text: "decodes"}},
    {
        type: "uses",
        color: c.orange,
        d: "M1090 632 L1150 632 L1150 440 L1295 440 L1295 343",
        label: {x: 1135, y: 485, text: "uses statementOf"}
    },
    ...
    {type: "uses", color: c.blue, d: "M328 930 L328 730", label: {x: 430, y: 838, text: "defaults/cache"}},
    {
        type: "uses",
        color: c.purple,
        d: "M878 930 L878 805 L1320 805 L1320 730",
        label: {x: 1110, y: 780, text: "feeds statements"}
    },
...
function arrowHead(e) {
    const n = nums(e.d), end = {x: n[n.length - 2], y: n[n.length - 1]},
        prev = {x: n[n.length - 4], y: n[n.length - 3]};
