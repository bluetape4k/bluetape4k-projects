...
const body = [
  ...
  edge({ points: [[502, 285], [665, 285]], color: "blue", label: "sync API", labelAt: [545, 272] }),
  edge({ points: [[300, 210], [300, 145], [1770, 145], [1770, 190]], color: "teal", label: "suspend API", labelAt: [1030, 132] }),
  edge({ points: [[945, 455], [945, 580]], color: "orange", label: "configured by", labelAt: [962, 520] }),
  edge({ points: [[1770, 455], [1770, 520], [1315, 520], [1315, 580]], color: "orange", label: "configured by", labelAt: [1788, 505] }),
  edge({ points: [[945, 800], [945, 850], [525, 850], [525, 900]], color: "green", label: "front cache", labelAt: [600, 837] }),
  edge({ points: [[1130, 800], [1130, 900]], color: "slate", label: "remote keyspace", labelAt: [1148, 860] }),
  edge({ points: [[1315, 800], [1315, 850], [1745, 850], [1745, 900]], color: "pink", label: "tracking listener", labelAt: [1485, 837] }),
  edge({ points: [[785, 1018], [875, 1018]], color: "slate", label: "miss/write", labelAt: [802, 1005] }),
  edge({ points: [[1395, 1018], [1485, 1018]], color: "pink", label: "invalidate push", labelAt: [1408, 1005] }),
  edge({ points: [[1485, 1082], [1425, 1082], [1425, 1170], [525, 1170], [525, 1135]], color: "green", label: "local invalidate", labelAt: [930, 1157] }),
];
