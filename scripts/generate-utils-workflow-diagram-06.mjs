...
const edges = [
    {
        ...
        to: "decision",
        d: "M840 306 L840 350",
        label: {x: 910, y: 330, text: "evaluate", w: 82}
    },
    {
        id: "yes",
        color: colors.green,
        from: "decision",
        to: "then",
        d: "M675 435 L520 435 L520 560",
        label: {x: 560, y: 410, text: "true", w: 58}
    },
    {
        id: "missing",
        color: colors.orange,
        ...
        d: "M840 520 L840 560",
        dashed: true,
        label: {x: 930, y: 540, text: "no branch", w: 94}
    },
    {
        id: "no",
        color: colors.pink,
        from: "decision",
        to: "otherwise",
        d: "M1005 435 L1160 435 L1160 560",
        label: {x: 1120, y: 410, text: "false", w: 62}
    },
    {
        id: "thenReport",
        color: colors.green,
        from: "then",
        to: "report",
        d: "M400 678 L400 782 L580 782",
        label: {x: 476, y: 760, text: "returns", w: 78}
    },
    {
        id: "noopReport",
        color: colors.orange,
        ...
        d: "M840 678 L840 725",
        dashed: true,
        label: {x: 920, y: 704, text: "success", w: 82}
    },
    {
        id: "otherwiseReport",
        color: colors.pink,
        from: "otherwise",
        to: "report",
        d: "M1280 678 L1280 782 L1100 782",
        label: {x: 1204, y: 760, text: "returns", w: 78}
    },
];
