...
const boxes = {
  ...
  queryBuilder: {
    x: 90, y: 480, w: 345, h: 178, fill: "#FFF7ED", stroke: c.orange,
  ...
  bindImpl: {
    ...
    stereo: "internal class", title: "BindSpecImpl<T>", members: ["- namedParameters", "- indexedParameters", "+ maps rows through converter"],
  },
  rowsFetch: {
