...
| 대 (100,000건) | 136,798 | 96,993 | JDBC 1.4× |
...
| 중 (10,000건) | 61,349 | 3,669 | JDBC 16.7× |
| 대 (100,000건) | 72,046 | 3,185 | JDBC 22.6× |
...
| 중 (10,000건) | 35,587 | 4,269 | JDBC 8.3× |
| 대 (100,000건) | 48,053 | 4,061 | JDBC 11.8× |
...
- **소규모 (100건)**: H2만 R2DBC가 빠름(2.6×); PostgreSQL·MySQL은 JDBC가 유리
- **중·대규모 (10,000건+)**: JDBC(HikariCP + VirtualThread)가 일관되게 빠름
  - PostgreSQL: JDBC가 R2DBC 대비 **16–22배** 빠름
  - MySQL: JDBC가 R2DBC 대비 **8–12배** 빠름 (MySQL R2DBC 드라이버 왕복 비용)
