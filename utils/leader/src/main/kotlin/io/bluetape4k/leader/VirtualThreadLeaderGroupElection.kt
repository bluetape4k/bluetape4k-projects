 ...
 * - [VirtualThreadLeaderGroupElection]은 `action`이 `() -> T`이지만 결과를 [VirtualFuture]로 반환합니다.
 *
 ...
 *
 * ## [AsyncLeaderGroupElection] 과의 차이
 ...
 * ```
 */
interface VirtualThreadLeaderGroupElection : LeaderGroupElection {
