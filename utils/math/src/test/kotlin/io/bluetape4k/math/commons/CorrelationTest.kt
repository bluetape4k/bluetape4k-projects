...
class CorrelationTest {
    ...
    fun `calc correlation with one sequence`() {
        ...
        coefficient.approximateEqual(1.0, EPSILON).shouldBeTrue()
    }
    ...
    fun `calc correlation with sequences that has different size`() {
        ...
        coefficient.approximateEqual(1.0, EPSILON).shouldBeFalse()
        ...
        coefficient2.approximateEqual(1.0, EPSILON).shouldBeFalse()
    }
}
