...
internal const val Mask58Bits = 0x1FL // 32 encoding value (0..31)
internal const val Mask58BitsCount = 5 // 5 bits, needed to encode 32 value
...
internal const val AllBitsSet = -0x1L
