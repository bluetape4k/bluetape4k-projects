...
class ImmutableLongArrayExtensionsTest {

    companion object: KLogging()

    @Test
    fun `chunk immutable array - partial windowed`() {
        val array = immutableArrayOf(1L, 2, 3, 4, 5)
        val chunks = array.chunked(3, true)

        chunks shouldBeEqualTo immutableArrayOf(
            immutableArrayOf(1L, 2, 3),
            immutableArrayOf(4L, 5)
        )
