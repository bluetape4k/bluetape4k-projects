 ...
 *
 * ```kotlin
 * // byteArrayListOf(1, 3).maxOrNull() == 3.toByte()
 * // byteArrayListOf().maxOrNull() == null
 * ```
 */
 ...
 *
 * ```kotlin
 * // byteArrayListOf(1, 3).minOrNull() == 1.toByte()
 * // byteArrayListOf().minOrNull() == null
 * ```
 */
 ...
 *
 * ```kotlin
 * // byteArrayListOf(2, 3).product() == 6.0
 * // byteArrayListOf().product() == 1.0
 * ```
 */
