 ...
 *
 * ```kotlin
 * val d = 100.nanos()  // Duration.ofNanos(100)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 50.micros()  // Duration.ofNanos(50_000)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 300.millis()  // Duration.ofMillis(300)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 30.seconds()  // Duration.ofSeconds(30)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 5.minutes()  // Duration.ofMinutes(5)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 2.hours()  // Duration.ofHours(2)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 7.days()  // Duration.ofDays(7)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 2.weeks()  // Duration.ofDays(14)
 * ```
 */
 ...
 *
 * ```kotlin
 * val p = 10.dayPeriod()  // Period.ofDays(10)
 * ```
 */
 ...
 *
 * ```kotlin
 * val p = 3.weekPeriod()  // Period.ofWeeks(3)
 * ```
 */
 ...
 *
 * ```kotlin
 * val p = 6.monthPeriod()  // Period.ofMonths(6)
 * ```
 */
 ...
 *
 * ```kotlin
 * val p = 1.yearPeriod()  // Period.ofYears(1)
 * ```
 */
 ...
 *
 * ```kotlin
 * val nanos = 1.millisToNanos()  // 1_000_000
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 3 * Duration.ofSeconds(10)  // Duration.ofSeconds(30)
 * ```
 */
 ...
 *
 * ```kotlin
 * val p = 3 * Period.ofMonths(2)  // Period.ofMonths(6)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = Duration.ofSeconds(5) * 3  // Duration.ofSeconds(15)
 * ```
 */
 ...
 *
 * ```kotlin
 * val p = Period.ofDays(3) * 2  // Period.ofDays(6)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = Duration.ofSeconds(30) / 3  // Duration.ofSeconds(10)
 * ```
 */
 ...
 *
 * ```kotlin
 * val p = Period.of(2, 4, 6) / 2  // Period.of(1, 2, 3)
 * ```
 */
 ...
 *
 * ```kotlin
 * val instant = 1_000.toInstant()  // Instant.ofEpochMilli(1_000)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 100L.nanos()  // Duration.ofNanos(100)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 50L.micros()  // Duration.ofNanos(50_000)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 300L.millis()  // Duration.ofMillis(300)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 30L.seconds()  // Duration.ofSeconds(30)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 5L.minutes()  // Duration.ofMinutes(5)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 2L.hours()  // Duration.ofHours(2)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 7L.days()  // Duration.ofDays(7)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 2L.weeks()  // Duration.ofDays(14)
 * ```
 */
 ...
 *
 * ```kotlin
 * val nanos = 1L.millisToNanos()  // 1_000_000L
 * ```
 */
 ...
 *
 * ```kotlin
 * 2024L.isLeapYear()  // true
 * 2023L.isLeapYear()  // false
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = 3L * Duration.ofSeconds(10)  // Duration.ofSeconds(30)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = Duration.ofSeconds(5) * 3L  // Duration.ofSeconds(15)
 * ```
 */
 ...
 *
 * ```kotlin
 * val d = Duration.ofSeconds(30) / 3L  // Duration.ofSeconds(10)
 * ```
 */
 ...
 *
 * ```kotlin
 * val instant = 1_614_556_800_000L.toInstant()  // 2021-03-01T00:00:00Z
 * ```
 */
 ...
 *
 * ```kotlin
 * val ym = yearMonthOf(2024, Month.MARCH)  // 2024-03
 * ```
 */
 ...
 *
 * ```kotlin
 * val ym = yearMonthOf(2024, 3)  // 2024-03
 * ```
 */
 ...
 *
 * ```kotlin
 * val md = monthDayOf(Month.MARCH, 15)  // --03-15
 * ```
 */
 ...
 *
 * ```kotlin
 * val (secs, nanos) = Duration.ofSeconds(5, 100)
 * // secs == 5L, nanos == 100
 * ```
 */
 ...
 *
 * ```kotlin
 * val (years, months, days) = Period.of(1, 2, 3)
 * // years == 1
 * ```
 */
 ...
 *
 * ```kotlin
 * val ym = Year.of(2024) + Month.MARCH  // 2024-03
 * ```
 */
 ...
 *
 * ```kotlin
 * val date = Year.of(2024) + MonthDay.of(3, 15)  // 2024-03-15
 * ```
 */
 ...
 *
 * ```kotlin
 * val ym = YearMonth.of(2023, 3) + Year.of(1)  // 2024-03
 * ```
 */
 ...
 *
 * ```kotlin
 * val ym = YearMonth.of(2024, 1) + Month.FEBRUARY  // 2024-03
 * ```
 */
