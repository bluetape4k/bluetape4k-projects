...
fun ByteArray?.encodeBase64String(): String =
    this?.run { base64Encoder.encode(this) }.orEmpty()
...
fun String?.encodeBase64String(): String =
    this?.run { base64Encoder.encode(this.toUtf8Bytes()) }.orEmpty()
...
fun ByteArray?.decodeBase64String(): String =
    this?.run { base64Encoder.decode(this.toUtf8String()).toUtf8String() }.orEmpty()
...
fun String?.decodeBase64String(): String =
    this?.run { base64Encoder.decode(this).toUtf8String() }.orEmpty()
...
fun ByteArray?.encodeHexString(): String =
    this?.run { hexEncoder.encode(this) }.orEmpty()
...
fun String?.encodeHexString(): String =
    this?.run { hexEncoder.encode(this.toUtf8Bytes()) }.orEmpty()
...
fun ByteArray?.decodeHexString(): String =
    this?.run { hexEncoder.decode(this.toUtf8String()).toUtf8String() }.orEmpty()
...
fun String?.decodeHexString(): String =
    this?.run { hexEncoder.decode(this).toUtf8String() }.orEmpty()
