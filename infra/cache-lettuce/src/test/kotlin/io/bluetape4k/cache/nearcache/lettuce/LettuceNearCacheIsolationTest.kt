 ...
 *
 * 같은 Redis DB를 공유하는 여러 [LettuceNearCache] / [LettuceNearSuspendCache] 인스턴스가
...
class LettuceNearCacheIsolationTest : AbstractLettuceNearCacheTest() {
    ...
    // ---- 코루틴 캐시 인스턴스 2개 ----
    private lateinit var suspendCacheX: LettuceNearSuspendCache<String>
    private lateinit var suspendCacheY: LettuceNearSuspendCache<String>
    ...
    fun createCaches() {
        ...
        suspendCacheX = LettuceNearSuspendCache(resp3Client, StringCodec.UTF8, NearCacheConfig(cacheName = "isolation-x"))
        suspendCacheY = LettuceNearSuspendCache(resp3Client, StringCodec.UTF8, NearCacheConfig(cacheName = "isolation-y"))
    }
