...
/**
 * Lettuce SuspendCache 백엔드를 사용하는 [AbstractSuspendNearCacheTest] 구현체입니다.
 *
 * Caffeine front + Lettuce SuspendCache back 2-tier SuspendNearCache 패턴을 검증합니다.
 * [io.bluetape4k.cache.jcache.LettuceSuspendCache]의 Channel 기반 [javax.cache.event.CacheEntryListener] 지원으로
 * 이벤트 전파가 동작합니다.
 */
class LettuceJCacheSuspendNearCacheTest: AbstractSuspendNearCacheTest() {
