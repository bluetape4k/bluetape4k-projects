...
/**
 * Lettuce 기반 Near Cache (2-tier cache)의 동기(Blocking) 공통 인터페이스.
 *
 * [LettuceNearCache]와 [ResilientLettuceNearCache]가 이 인터페이스를 구현하여
 * 다형적으로 사용할 수 있도록 한다.
 *
 * @param V 값 타입 (키는 항상 String)
 */
interface LettuceNearCacheOperations<V: Any>: AutoCloseable {
