...
import io.bluetape4k.cache.jcache.lettuce.LettuceCacheManager
import io.bluetape4k.cache.jcache.lettuce.LettuceCachingProvider
import io.bluetape4k.cache.jcache.lettuce.lettuceCacheConfigOf
 ...
 *
 * ```kotlin
 * val cache = JLettuceCaching.getOrCreate<String, String>("my-cache")
 * cache.put("key", "value")
 * ```
 */
object JLettuceCaching: KLogging() {
