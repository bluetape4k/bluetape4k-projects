...
class AttributeKeySupportTest: AbstractOtelTest() {
    ...
    fun `create attribute keys with of function`() {
        ...
        stringArrayAttributeKeyOf("string.array.key") shouldBeEqualTo
                AttributeKey.stringArrayKey("string.array.key")
        booleanArrayAttributeKeyOf("boolean.array.key") shouldBeEqualTo
                AttributeKey.booleanArrayKey("boolean.array.key")
        longArrayAttributeKeyOf("long.array.key") shouldBeEqualTo
                AttributeKey.longArrayKey("long.array.key")
        doubleArrayAttributeKeyOf("double.array.key") shouldBeEqualTo
                AttributeKey.doubleArrayKey("double.array.key")
    }
    ...
    fun `convert map to attributes`() {
        ...
        attributes[stringAttributeKeyOf("string.key")] shouldBeEqualTo "string.value"
        attributes[longAttributeKeyOf("int.key")] shouldBeEqualTo 123L
        attributes[longAttributeKeyOf("long.key")] shouldBeEqualTo 123L
        attributes[doubleAttributeKeyOf("double.key")] shouldBeEqualTo 123.456
        attributes[booleanAttributeKeyOf("boolean.key")].shouldNotBeNull().shouldBeTrue()
        attributes[stringArrayAttributeKeyOf("string.array.key")] shouldBeEqualTo listOf("a", "b", "c")
        attributes[longArrayAttributeKeyOf("long.array.key")] shouldBeEqualTo listOf(1L, 2L, 3L)
    }
}
