...
class IgniteNearCacheManager(
    ...
    private fun checkNotClosed() {
        check(!isClosed) { "IgniteNearCacheManager is closed." }
    }
    ...
    override fun <K: Any, V: Any, C: Configuration<K, V>> createCache(
        ...
        val nearCacheConfig = configuration as? IgniteNearCacheConfig<K, V>
        check(nearCacheConfig != null) { "configuration is not IgniteNearCacheConfig type." }

        val backCacheManager = jcacheManagerOf("org.apache.ignite.cache.CachingProvider")
