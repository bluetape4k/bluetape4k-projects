...
/**
 * [ResilientNearJCache] 및 [ResilientSuspendNearJCache]의 front tier 로컬 캐시 추상화.
 *
 ...
 * @param V 값 타입
 */
interface ResilientLocalJCache<K: Any, V: Any>: AutoCloseable {
 ...
 * @param V 값 타입
 */
class CaffeineResilientLocalJCache<K: Any, V: Any>(
