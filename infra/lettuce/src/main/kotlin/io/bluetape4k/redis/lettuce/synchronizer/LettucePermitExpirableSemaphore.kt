...
class LettucePermitExpirableSemaphore internal constructor(
    ...
    fun release(handle: ExpirablePermitHandle): PermitMutationResult<ExpirablePermitHandle> = client.release(handle)
    ...
    fun renewAsync(
        ...
        extension: Duration
    ): CompletableFuture<PermitRenewResult<ExpirablePermitHandle>> = client.renewAsync(handle, extension)
    ...
    companion object: KLogging() {
        ...
        @JvmStatic
        fun create(connection: StatefulRedisConnection<String, String>, name: String): LettucePermitExpirableSemaphore =
