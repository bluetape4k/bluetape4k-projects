...
class SynchronizerAmbiguityTest {
    ...
    private val sync = mockk<RedisCommands<String, String>>()
    private val async = mockk<RedisAsyncCommands<String, String>>(relaxed = true)
    ...
    fun `post dispatch timeout returns request-bound ambiguous outcomes`() {
        ...
        try {
            ...
            latch.countDown(
                LatchGeneration(1),
                LatchRequestId.from("latch-request")
