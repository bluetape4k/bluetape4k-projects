...
- **BOM**: `implementation(platform(Libs.spring_boot4_dependencies))` 필수
...
- [`bluetape4k-spring-boot4-hibernate-lettuce`](../hibernate-lettuce/README.ko.md) — Auto-Configuration 모듈
