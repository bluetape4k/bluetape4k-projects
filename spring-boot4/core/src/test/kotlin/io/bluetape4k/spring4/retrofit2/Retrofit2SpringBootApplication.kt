...
import io.bluetape4k.spring4.retrofit2.services.httpbin.HttpbinApi
import io.bluetape4k.spring4.retrofit2.services.jsonplaceholder.JsonPlaceHolderApi
...
class Retrofit2SpringBootApplication {
    ...
    class Retrofit2SampleRunner: CommandLineRunner {
        ...
        override fun run(vararg args: String?) {
            runBlocking {
                val users = jsonPlaceHolderApi.getUsers().awaitResponse()
