package io.bluetape4k.spring4.ui
 ...
 * ```
 */
fun ModelMap.addAttributes(vararg pairs: Pair<String, Any?>): ModelMap = addAllAttributes(pairs.toMap())
 ...
 * ```
 */
fun ModelMap.mergeAttributes(vararg pairs: Pair<String, Any?>): ModelMap = mergeAttributes(pairs.toMap())
