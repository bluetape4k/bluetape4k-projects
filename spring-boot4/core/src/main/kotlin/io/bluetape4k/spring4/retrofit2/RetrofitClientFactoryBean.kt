...
class RetrofitClientFactoryBean :
    ...
    override fun getObject(): Any? {
        ...
        if (client != null) {
            ...
            val callFactory =
                retrofitClientContext.getInstance(this.name, Call.Factory::class.java)
        ...
        retrofitClientContext
            .getInstances(this.name, Converter.Factory::class.java)
            ?.forEach { (key, factory) ->
        ...
        retrofitClientContext
            .getInstances(this.name, CallAdapter.Factory::class.java)
            ?.forEach { (key, factory) ->
