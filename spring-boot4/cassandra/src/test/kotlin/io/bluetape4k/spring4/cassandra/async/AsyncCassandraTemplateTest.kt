package io.bluetape4k.spring4.cassandra.async
...
import io.bluetape4k.spring4.cassandra.domain.DomainTestConfiguration
import io.bluetape4k.spring4.cassandra.domain.model.User
import io.bluetape4k.spring4.cassandra.domain.model.UserToken
...
class AsyncCassandraTemplateTest(
    ...
    @Test
    fun `insert entity`() = runSuspendIO {
        val user = newUser()
    ...
    @Test
    fun `존재하지 않을 시에만 신규로 저장`() = runSuspendIO {
