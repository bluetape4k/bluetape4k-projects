...
suspend inline fun <reified T : Any> ReactiveCassandraOperations.suspendUpdate(
    query: Query,
    update: Update,
...
suspend inline fun <reified T : Any> ReactiveCassandraOperations.suspendCount(): Long = countSuspending<T>()
...
suspend inline fun <reified T : Any> ReactiveCassandraOperations.suspendExists(): Boolean = existsSuspending<T>()
...
suspend fun <T : Any> ReactiveCassandraOperations.suspendInsert(entity: T): T = insertSuspending(entity)
...
suspend fun <T : Any> ReactiveCassandraOperations.suspendUpdate(entity: T): T = updateSuspending(entity)
...
suspend fun <T : Any> ReactiveCassandraOperations.suspendDelete(entity: T): T = deleteSuspending(entity)
...
suspend fun <T : Any> ReactiveCassandraOperations.suspendDelete(
    entity: T,
    options: QueryOptions,
