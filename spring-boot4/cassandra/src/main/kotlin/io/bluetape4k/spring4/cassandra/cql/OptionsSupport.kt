package io.bluetape4k.spring4.cassandra.cql
 ...
 * ```
 */
inline fun queryOptions(builder: QueryOptions.QueryOptionsBuilder.() -> Unit): QueryOptions =
 ...
 * ```
 */
inline fun insertOptions(builder: InsertOptions.InsertOptionsBuilder.() -> Unit): InsertOptions =
 ...
 * ```
 */
inline fun updateOptions(builder: UpdateOptions.UpdateOptionsBuilder.() -> Unit): UpdateOptions =
 ...
 * ```
 */
inline fun writeOptions(builder: WriteOptions.WriteOptionsBuilder.() -> Unit): WriteOptions =
 ...
 * ```
 */
inline fun deleteOptions(builder: DeleteOptions.DeleteOptionsBuilder.() -> Unit): DeleteOptions =
