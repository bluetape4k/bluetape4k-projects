...
suspend fun AsyncCassandraOperations.suspendExecute(stmt: Statement<*>): AsyncResultSet = executeSuspending(stmt)
...
suspend inline fun <reified T : Any> AsyncCassandraOperations.suspendUpdate(
    query: Query,
    update: Update,
): Boolean? = updateSuspending<T>(query, update)
...
suspend inline fun <reified T : Any> AsyncCassandraOperations.suspendCount(): Long? = countSuspending<T>()
...
suspend inline fun <reified T : Any> AsyncCassandraOperations.suspendExists(id: Any): Boolean? = existsSuspending<T>(id)
...
suspend fun <T : Any> AsyncCassandraOperations.suspendInsert(entity: T): T? = insertSuspending(entity)
...
suspend fun <T : Any> AsyncCassandraOperations.suspendInsert(
    entity: T,
    options: InsertOptions,
): EntityWriteResult<T> = insertSuspending(entity, options)
...
suspend fun <T : Any> AsyncCassandraOperations.suspendUpdate(entity: T): T? = updateSuspending(entity)
...
suspend fun <T : Any> AsyncCassandraOperations.suspendUpdate(
    entity: T,
    options: UpdateOptions,
): EntityWriteResult<T> = updateSuspending(entity, options)
...
suspend fun <T : Any> AsyncCassandraOperations.suspendDelete(entity: T): T? = deleteSuspending(entity)
...
suspend fun AsyncCassandraOperations.suspendDelete(
    entity: Any,
    options: DeleteOptions,
): WriteResult = deleteSuspending(entity, options)
