...
@SpringBootTest(
    ...
    properties = [
        ...
        // Spring Boot 4 split auto-configuration modules can register duplicate JPA/JDBC beans
        // on this narrow test classpath, so the framework defaults are excluded explicitly.
