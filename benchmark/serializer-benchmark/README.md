...
The 44 cells cover JDK (6), Kryo (6), Fory (4), Jackson 2 (6), Jackson 3 (6), Fastjson2 (6), Avro reflect (6), and the Kryo-backed Kafka codec (4), with serialization and deserialization measured separately. Compatibility and fallback cells are ergonomic-only controls.
...
See the [2026-07-18 report](../../docs/benchmarks/2026-07-18-bytebuffer-serializer-allocation.md) and committed raw evidence. Issues #755, #756, and #757 remain explicitly out of scope.
Allocation evidence for #758 is documented in the [issue #758 report](../../docs/benchmarks/2026-07-19-kafka-bytebuffer-codec-allocation.md).
