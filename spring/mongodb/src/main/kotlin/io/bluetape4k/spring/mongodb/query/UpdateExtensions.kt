 ...
 * ```
 */
fun Update.andSet(field: String, value: Any?): Update = set(field, value)
 ...
 * ```
 */
fun Update.andInc(field: String, value: Number): Update = inc(field, value)
 ...
 * ```
 */
fun Update.andPush(field: String, value: Any): Update = push(field, value)
