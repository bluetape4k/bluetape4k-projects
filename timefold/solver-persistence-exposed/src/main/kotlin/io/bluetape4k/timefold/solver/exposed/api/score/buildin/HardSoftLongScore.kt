 ...
 *
 * Kotlin String 타입과 [HardSoftLongScore] 간의 변환을 처리합니다.
 *
 * ```kotlin
 * val columnType = HardSoftLongScoreColumnType(255)
 * val score = HardSoftLongScore.of(100L, -50L)
 ...
 *
 * ```kotlin
 * val transformer = HardSoftLongScoreTransformer()
 * val score = HardSoftLongScore.of(100L, -50L)
...
class HardSoftLongScoreTransformer: ColumnTransformer<String, HardSoftLongScore> {
     ...
     * ```kotlin
     * val score = HardSoftLongScore.of(100L, -50L)
     * val raw = HardSoftLongScoreTransformer().unwrap(score)
     * // raw == score.toString()
     * ```
     *
     ...
     * val restored = HardSoftLongScoreTransformer().wrap(raw)
     * // restored == score
     * ```
     *
