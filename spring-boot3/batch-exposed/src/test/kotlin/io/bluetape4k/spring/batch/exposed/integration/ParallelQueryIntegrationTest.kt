...
class ParallelQueryIntegrationTest : AbstractExposedBatchJobTest() {
    ...
    class JobConfig(
        ...
        @Bean(name = ["parallelJobLauncherTestUtils"])
        fun jobLauncherTestUtils(
            @org.springframework.beans.factory.annotation.Qualifier("parallelMigrationJob") job: Job,
    ...
    @Autowired
    @org.springframework.beans.factory.annotation.Qualifier("parallelJobLauncherTestUtils")
