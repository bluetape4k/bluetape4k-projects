...
After understanding the low-level JDBC boundary, continue with [Choosing what comes after JDBC](./ecosystem-paths.md) to decide whether to keep it or move to Exposed or Hibernate.
