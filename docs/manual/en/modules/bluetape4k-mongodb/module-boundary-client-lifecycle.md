...
Use [`bluetape4k-spring-boot-mongodb`](../bluetape4k-spring-boot-mongodb.md) when repositories and mapping are required. This module does not provide Spring lifecycle or auto-configuration.
