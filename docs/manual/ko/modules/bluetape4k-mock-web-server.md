...
[![Mock Web Server 요청 라우팅 개요](../../assets/readme-diagrams/testing-mock-web-server-diagram-01.png)](../../assets/readme-diagrams/testing-mock-web-server-diagram-01.svg)

_배포본 README: [`testing/mock-web-server/README.ko.md`](https://github.com/bluetape4k/bluetape4k-projects/blob/6187173b58e8b4c5c435c145e00e94708f31ef75/testing/mock-web-server/README.ko.md)_

### Mock Web Server 클래스 구조

[![Mock Web Server 클래스 구조](../../assets/readme-diagrams/testing-mock-web-server-diagram-02.png)](../../assets/readme-diagrams/testing-mock-web-server-diagram-02.svg)

_배포본 README: [`testing/mock-web-server/README.ko.md`](https://github.com/bluetape4k/bluetape4k-projects/blob/6187173b58e8b4c5c435c145e00e94708f31ef75/testing/mock-web-server/README.ko.md)_

### httpbin GET 요청 시퀀스

[![httpbin GET 요청 시퀀스](../../assets/readme-diagrams/testing-mock-web-server-sequence-01.png)](../../assets/readme-diagrams/testing-mock-web-server-sequence-01.svg)
