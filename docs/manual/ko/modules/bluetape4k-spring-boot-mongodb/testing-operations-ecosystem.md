...
| MongoDB Kotlin driver, codec, collection API 직접 제어 | [`bluetape4k-mongodb`](../bluetape4k-mongodb.md) |
...
도입할 계층을 정했다면 [자동 설정과 구성 경계](./auto-configuration-boundaries.md)로 돌아가 애플리케이션이 소유할 bean과 설정을 고정합니다.
