...
위 좌표를 추가하고 Gradle을 refresh한 뒤 필요한 작업을 소유한 가장 작은 entry point에서 시작합니다. 먼저 [`AsyncCassandraOperationsCoroutines`](../../../../spring-boot/cassandra/src/main/kotlin/io/bluetape4k/spring/cassandra/AsyncCassandraOperationsCoroutines.kt)를 확인합니다. 이 파일이 모듈의 구체적인 source entry point입니다.

## 작업별 API {#api-by-task}

| Entry point | 확인할 내용 |
| --- | --- |
| [`AsyncCassandraOperationsCoroutines`](../../../../spring-boot/cassandra/src/main/kotlin/io/bluetape4k/spring/cassandra/AsyncCassandraOperationsCoroutines.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`ReactiveCassandraBatchOperationsCoroutines`](../../../../spring-boot/cassandra/src/main/kotlin/io/bluetape4k/spring/cassandra/ReactiveCassandraBatchOperationsCoroutines.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`ReactiveCassandraOperationsCoroutines`](../../../../spring-boot/cassandra/src/main/kotlin/io/bluetape4k/spring/cassandra/ReactiveCassandraOperationsCoroutines.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`ReactiveSelectOperationSupport`](../../../../spring-boot/cassandra/src/main/kotlin/io/bluetape4k/spring/cassandra/ReactiveSelectOperationSupport.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`ReactiveSessionCoroutines`](../../../../spring-boot/cassandra/src/main/kotlin/io/bluetape4k/spring/cassandra/ReactiveSessionCoroutines.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`AsyncCqlOperationsCoroutines`](../../../../spring-boot/cassandra/src/main/kotlin/io/bluetape4k/spring/cassandra/cql/AsyncCqlOperationsCoroutines.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`OptionsSupport`](../../../../spring-boot/cassandra/src/main/kotlin/io/bluetape4k/spring/cassandra/cql/OptionsSupport.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`ReactiveCqlOperationsSupport`](../../../../spring-boot/cassandra/src/main/kotlin/io/bluetape4k/spring/cassandra/cql/ReactiveCqlOperationsSupport.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`AbstractCassandraAuditable`](../../../../spring-boot/cassandra/src/main/kotlin/io/bluetape4k/spring/cassandra/model/AbstractCassandraAuditable.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`AbstractCassandraPersistable`](../../../../spring-boot/cassandra/src/main/kotlin/io/bluetape4k/spring/cassandra/model/AbstractCassandraPersistable.kt) | constructor, function, ownership 계약을 확인합니다. |
...
- [모듈 README](../../../../spring-boot/cassandra/README.ko.md)
- [모듈 build](../../../../spring-boot/cassandra/build.gradle.kts)
