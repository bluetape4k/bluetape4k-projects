...
1.11.0의 [`infra/redis/build.gradle.kts`](../../../../../infra/redis/build.gradle.kts)는 다음 두 의존성만 선언합니다.
...
실제 client API와 실패 계약은 [Lettuce 매뉴얼](../bluetape4k-lettuce.md)과 [Redisson 매뉴얼](../bluetape4k-redisson.md)에 있습니다.
