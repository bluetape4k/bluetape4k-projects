...
위 좌표를 추가하고 Gradle을 refresh한 뒤 필요한 작업을 소유한 가장 작은 entry point에서 시작합니다. 먼저 [`Bluetape4kKtorObservability`](../../../../ktor/observability/src/main/kotlin/io/bluetape4k/ktor/observability/Bluetape4kKtorObservability.kt)를 확인합니다. 이 파일이 모듈의 구체적인 source entry point입니다.

## 작업별 API {#api-by-task}

| Entry point | 확인할 내용 |
| --- | --- |
| [`Bluetape4kKtorObservability`](../../../../ktor/observability/src/main/kotlin/io/bluetape4k/ktor/observability/Bluetape4kKtorObservability.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`Bluetape4kKtorObservabilityConfig`](../../../../ktor/observability/src/main/kotlin/io/bluetape4k/ktor/observability/Bluetape4kKtorObservabilityConfig.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`CallLoggingSettings`](../../../../ktor/observability/src/main/kotlin/io/bluetape4k/ktor/observability/CallLoggingSettings.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`CorrelationIdSettings`](../../../../ktor/observability/src/main/kotlin/io/bluetape4k/ktor/observability/CorrelationIdSettings.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`KtorCallIdSupport`](../../../../ktor/observability/src/main/kotlin/io/bluetape4k/ktor/observability/KtorCallIdSupport.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`KtorCallLoggingSupport`](../../../../ktor/observability/src/main/kotlin/io/bluetape4k/ktor/observability/KtorCallLoggingSupport.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`KtorOpenTelemetryTracingConfig`](../../../../ktor/observability/src/main/kotlin/io/bluetape4k/ktor/observability/KtorOpenTelemetryTracingConfig.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`KtorOpenTelemetryTracingSupport`](../../../../ktor/observability/src/main/kotlin/io/bluetape4k/ktor/observability/KtorOpenTelemetryTracingSupport.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`KtorPrometheusRoutes`](../../../../ktor/observability/src/main/kotlin/io/bluetape4k/ktor/observability/KtorPrometheusRoutes.kt) | constructor, function, ownership 계약을 확인합니다. |
...
### Ktor Observability 구성 요소

[![Ktor Observability 구성 요소](https://raw.githubusercontent.com/bluetape4k/bluetape4k-projects/6187173b58e8b4c5c435c145e00e94708f31ef75/docs/images/readme-diagrams/ktor-observability-component-01.png)](https://github.com/bluetape4k/bluetape4k-projects/blob/6187173b58e8b4c5c435c145e00e94708f31ef75/docs/images/readme-diagrams/ktor-observability-component-01.svg)

_배포본 README: [`ktor/observability/README.ko.md`](https://github.com/bluetape4k/bluetape4k-projects/blob/6187173b58e8b4c5c435c145e00e94708f31ef75/ktor/observability/README.ko.md)_

<!-- release-readme-diagrams:end -->

## 근거 {#sources}

- [모듈 README](../../../../ktor/observability/README.ko.md)
- [모듈 build](../../../../ktor/observability/build.gradle.kts)
