...
# 설정, codec과 client 소유권

## 기본값부터 명시한다

`RedissonNearCacheConfig`의 1.11.0 기본값은 다음과 같습니다.
...
- [`RedissonNearCacheConfigTest.kt`](../../../../../cache/cache-redisson/src/test/kotlin/io/bluetape4k/cache/nearcache/RedissonNearCacheConfigTest.kt)
