...
`data/hibernate`, `data/hibernate-reactive`, `data/hibernate-cache-lettuce` 모듈은 현재 **Hibernate ORM 6.6.x / Hibernate
Reactive 2.4.x** 라인을 기반으로 한다. 이 라인은 다음과 같은 한계를 가진다.
