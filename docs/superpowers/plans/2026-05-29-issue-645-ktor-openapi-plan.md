...
1. Add Ktor OpenAPI, routing OpenAPI, and Swagger UI aliases using the governed Ktor version.
...
5. Verify with module compile, module tests, Kover XML, actionlint, and diff hygiene.

## Acceptance Mapping

- Dependency choice: captured in the design note.
- Generated/served output: covered by `/openapi` and `/swagger` tests using a static spec.
