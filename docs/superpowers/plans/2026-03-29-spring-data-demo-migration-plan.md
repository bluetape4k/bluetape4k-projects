...
**날짜**: 2026-03-29 **Spec**: `docs/superpowers/specs/2026-03-29-spring-data-demo-migration-design.md`
...
- **experimental JDBC 소스
  경로**: `/Users/debop/work/bluetape4k/bluetape4k-experimental/examples/exposed-jdbc-spring-data-mvc-demo/`
...
- **experimental R2DBC 소스
  경로**: `/Users/debop/work/bluetape4k/bluetape4k-experimental/examples/exposed-r2dbc-spring-data-webflux-demo/`
...
- **Libs.kt 상수 확인
  완료**: `exposed_spring_boot_starter`, `exposed_spring_boot4_starter`, `exposed_spring_transaction`, `exposed_spring7_transaction`, `exposed_migration_jdbc` 모두 존재
...
- **수행 방법**:
    ...
    2. spec 섹션 4.4 기준으로 `build.gradle.kts` 작성:
       ...
       ```
    3. **핵심
       차이**: `implementation(platform(Libs.spring_boot4_dependencies))` + `project(":bluetape4k-spring-boot4-exposed-r2dbc")`
