...
class SuspendJpegWriter(
     ...
     *
     * ```kotlin
     * val writer = SuspendJpegWriter.Default.withCompression(95)
     * // writer.compression == 95
     * ```
     */
     ...
     *
     * ```kotlin
     * val writer = SuspendJpegWriter.Default.withProgressive(true)
     * // writer.progressive == true
     * ```
     */
