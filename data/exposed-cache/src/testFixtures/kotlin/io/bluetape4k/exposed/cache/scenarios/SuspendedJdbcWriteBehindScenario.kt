...
/**
 * [SuspendedJdbcCacheTestScenario] 기반 Write-Behind 캐시 suspend 시나리오입니다.
 *
...
interface SuspendedJdbcWriteBehindScenario<ID: Any, E: Serializable>: SuspendedJdbcCacheTestScenario<ID, E> {
