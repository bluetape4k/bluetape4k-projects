...
/**
 * Exposed R2DBC + Redis 캐시 기반 suspend 저장소의 공통 인터페이스입니다.
 *
 * [SuspendedJdbcCacheRepository]와 동일한 기능을 제공하되,
 * R2DBC 환경에서는 [ResultRow.toEntity]도 `suspend` 함수로 정의됩니다.
 *
