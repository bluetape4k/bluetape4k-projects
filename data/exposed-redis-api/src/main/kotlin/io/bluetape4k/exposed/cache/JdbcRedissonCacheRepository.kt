...
/**
 * Exposed JDBC + Redisson 캐시 기반 저장소의 공통 인터페이스입니다.
 *
 * [JdbcCacheRepository]를 확장하여 Redisson 고유의 패턴 기반 캐시 무효화 기능을 제공합니다.
 *
...
interface JdbcRedissonCacheRepository<ID: Any, E: Serializable>: JdbcCacheRepository<ID, E> {
     ...
     * @return 무효화된 캐시 항목 수
     */
    fun invalidateByPattern(patterns: String, count: Int = JdbcCacheRepository.DEFAULT_BATCH_SIZE): Long
}
