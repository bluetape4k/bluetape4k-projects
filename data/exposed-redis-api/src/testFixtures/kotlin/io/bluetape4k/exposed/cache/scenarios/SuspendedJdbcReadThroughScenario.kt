...
/**
 * [SuspendedJdbcCacheTestScenario] 기반 Read-Through 캐시 suspend 시나리오입니다.
 *
 ...
 * @param E 엔티티 타입
 */
interface SuspendedJdbcReadThroughScenario<ID: Any, E: Serializable>: SuspendedJdbcCacheTestScenario<ID, E> {
