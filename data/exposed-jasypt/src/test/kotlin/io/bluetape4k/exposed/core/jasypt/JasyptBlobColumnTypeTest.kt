...
class JasyptBlobColumnTypeTest: AbstractExposedTest() {

    private object T1: IntIdTable() {
        val name = varchar("name", 255)
        val aesBlob = jasyptBlob("aes_blob", Encryptors.DeterministicAES).nullable()
        val rc4Blob = jasyptBlob("rc4_blob", Encryptors.DeterministicRC4).nullable()
    }
