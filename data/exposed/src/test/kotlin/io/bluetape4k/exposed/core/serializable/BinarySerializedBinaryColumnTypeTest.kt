...
class BinarySerializedBinaryColumnTypeTest: AbstractExposedTest() {
    ...
    private object T1: IntIdTable() {
        val zstdFury = binarySerializedBinary<Embeddable>("zstd_fury", 4000, BinarySerializers.ZstdFury).nullable()
        val zstdKryo = binarySerializedBinary<Embeddable>("zstd_kryo", 4000, BinarySerializers.ZstdKryo).nullable()
        val lz4Fury = binarySerializedBinary<Embeddable2>("lz4_fury", 4000, BinarySerializers.LZ4Fury).nullable()
