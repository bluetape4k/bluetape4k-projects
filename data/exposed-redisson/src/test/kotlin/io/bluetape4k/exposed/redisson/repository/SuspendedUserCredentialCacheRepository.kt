...
): SuspendedExposedRedisRepository<UserSchema.UserCredential, String>(redissonClient, cacheName, config) {

    companion object: KLogging()

    override val entityTable: UserSchema.UserCredentialTable = UserSchema.UserCredentialTable
    override fun ResultRow.toEntity(): UserSchema.UserCredential = toUserCredential()

    override fun doUpdateEntity(
        statement: UpdateStatement,
        entity: UserSchema.UserCredential,
    ) {
