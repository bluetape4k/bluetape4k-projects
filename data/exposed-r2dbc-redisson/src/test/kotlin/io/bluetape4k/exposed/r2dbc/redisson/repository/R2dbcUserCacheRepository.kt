...
import io.bluetape4k.exposed.r2dbc.redisson.domain.UserSchema.toUserDTO
...
): AbstractR2dbcCacheRepository<UserDTO, Long>(redissonClient, cacheName, config) {

    companion object: KLoggingChannel()

    override val entityTable: UserTable = UserTable
    override suspend fun ResultRow.toEntity(): UserDTO = toUserDTO()
