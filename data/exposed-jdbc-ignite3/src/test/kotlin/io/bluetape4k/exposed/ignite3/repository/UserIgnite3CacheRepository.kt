...
import io.bluetape4k.exposed.ignite3.repository.UserSchema.UserRecord
import io.bluetape4k.exposed.ignite3.repository.UserSchema.toUserRecord
...
/**
 * Ignite 3.x 씬 클라이언트 기반 사용자 캐시 Repository 구현체입니다.
 *
 ...
 */
class UserIgnite3CacheRepository(
