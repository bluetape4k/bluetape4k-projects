...
import io.bluetape4k.exposed.cache.SuspendedJdbcRedissonCacheRepository
 ...
 */
interface SuspendedJdbcRedissonRepository<ID: Any, E: Serializable>: SuspendedJdbcRedissonCacheRepository<ID, E> {
    companion object {
