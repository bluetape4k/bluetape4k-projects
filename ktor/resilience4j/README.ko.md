...
bluetape4k 생태계의 Ktor 서버 애플리케이션에서 route 단위로 Resilience4j 정책을 적용하는 helper 모듈입니다.
...
메시지는 client에 노출해도 안전한 일반 문구만 사용합니다. 정책 이름은 caller가 소유한 Resilience4j 객체에 남기므로 metrics와 registry 소유권은 애플리케이션에 남습니다.
