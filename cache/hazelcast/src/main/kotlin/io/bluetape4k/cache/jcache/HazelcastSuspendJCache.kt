...
/**
 * Hazelcast JCache를 코루틴 친화적인 [SuspendJCache]로 감싼 구현체입니다.
 *
 * ## 동작/계약
 ...
 * ```
 */
class HazelcastSuspendJCache<K: Any, V: Any>(private val cache: JCache<K, V>): SuspendJCache<K, V> {

    companion object: KLoggingChannel() {
        /**
         * 캐시 이름과 구성으로 [HazelcastSuspendJCache]를 생성합니다.
         *
         * ## 동작/계약
        ...
        operator fun <K: Any, V: Any> invoke(
            ...
            return HazelcastSuspendJCache(jcache)
        }

        /**
         * reified 타입으로 키/값 타입이 지정된 [HazelcastSuspendJCache]를 생성합니다.
         *
         * ## 동작/계약
