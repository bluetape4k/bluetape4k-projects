package io.bluetape4k.examples.jpa.blazepersistence.domain.model
...
/**
 * Team aggregate used by the Blaze Persistence JPA examples.
 */
@Entity
...
class Team: LongJpaEntity() {
    ...
    fun removeMember(member: Member) {
        if (members.removeAll { it === member } && member.team == this) {
            member.team = null
        }
    }
