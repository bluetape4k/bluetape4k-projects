 ...
 * ```
 */
inline fun <reified T> ObjectMapper.readValueOrNull(
    input: ByteArray,
    offset: Int = 0,
 ...
 *
 * ```kotlin
 * val value: Map<String, Any>? = mapper.readValueOrNull(URL("https://api.example.com/data.json"))
 * // value != null (URL이 유효하고 JSON인 경우)
 * ```
 */
