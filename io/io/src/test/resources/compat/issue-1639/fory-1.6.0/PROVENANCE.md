...
(tree `3acf71b14db31d595bb8fc935891ca77e9c14577`)에 있는 payload와 generator를 중앙 catalog `e4d0748f6204083e4f4080eab8719e9155cd527b`로 해석해 생성했다. 이 catalog는
...
`testRuntimeClasspath`에서 source-file mode로 `GenerateForyWireFixture.java`를 실행한다. payload의 fully-qualified class name과 필드 목록은 `manifest.json`에 고정했다.
