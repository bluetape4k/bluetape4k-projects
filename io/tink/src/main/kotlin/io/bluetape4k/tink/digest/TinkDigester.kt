 ...
 */
class TinkDigester(val algorithmName: String) {
    ...
    fun digest(data: ByteArray): ByteArray =
        MessageDigest.getInstance(algorithmName).digest(data)
     ...
     */
    fun matches(data: ByteArray, expected: ByteArray): Boolean =
        MessageDigest.isEqual(digest(data), expected)
     ...
     * @return 일치하면 `true`, 아니면 `false`
     */
    fun matches(data: String, expected: String): Boolean =
