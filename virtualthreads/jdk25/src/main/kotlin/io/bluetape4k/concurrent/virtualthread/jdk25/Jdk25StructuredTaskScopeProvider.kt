...
class Jdk25StructuredTaskScopeProvider: StructuredTaskScopeProvider {
    ...
    override fun <T> withAny(
        ...
        return scope.use { block(Jdk25FirstScope(it)) }
    }
    ...
    private fun configure(
        ...
        return Function { conf ->
            var configured = conf.withThreadFactory(factory)
    ...
    private class Jdk25FirstScope<T>(
        private val delegate: StructuredTaskScope<T, T>,
    ): StructuredTaskScopeFirst<T> {
        ...
        override fun join(): StructuredTaskScopeFirst<T> {
